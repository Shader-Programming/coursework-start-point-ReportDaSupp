...
void Gui::drawGui()
{
    ...
    ImGui::SliderFloat3("Light Color", (float*)&guiVals.lightCol, -1.0, 1.0);
    ImGui::SliderFloat3("Floor Color", (float*)&guiVals.floorCol, -1.0, 1.0);
    ImGui::Checkbox("Wireframe", &guiVals.eWireframe);
