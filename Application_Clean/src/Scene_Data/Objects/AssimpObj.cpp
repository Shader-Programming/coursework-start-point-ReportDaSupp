...
void Model::setTransform(glm::mat4 model, glm::vec3 translation, glm::vec3 rotation, float rate, glm::vec3 scale)
{
...
void Model::loadModel(std::string const& path, bool flip)
{
