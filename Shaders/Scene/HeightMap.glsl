...
vec3 calculateNormal(ivec2 coords) {
    float hC = perlin(float(coords.x) / 100.0, float(coords.y) / 100.0, 0);
    float hL = perlin(float(coords.x - 1) / 100.0, float(coords.y) / 100.0, 0);
    float hR = perlin(float(coords.x + 1) / 100.0, float(coords.y) / 100.0, 0);
    float hD = perlin(float(coords.x) / 100.0, float(coords.y - 1) / 100.0, 0);
    float hU = perlin(float(coords.x) / 100.0, float(coords.y + 1) / 100.0, 0);
...
void main() {
    ...
    float d = perlin(float(texelCoords.x)/100, float(texelCoords.y)/100, ellapsedTime);
